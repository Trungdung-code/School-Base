                            ...
                            <form>
                                <div class="row">
                                    <div class="mb-3 col-lg-6 col-md-12 col-sm-12">
                                        <div>
                                            <label class="form-label" for="email">New email address</label><input
                                                required="" type="email" id="email" class="form-control" />
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="currentpassword">Current
                                                    Password</label><input required="" type="password"
                                                    id="currentpassword" class="form-control" value="" />
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="confirmpassword">Confirm New
                                                    Password</label><input required="" type="password"
                                                    id="confirmpassword" class="form-control" value="" />
                                            </div>
