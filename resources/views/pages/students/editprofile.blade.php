            ...
            <div class="card-body">
                <div class="d-lg-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center mb-4 mb-lg-0">
                        <img src="img/users/user7.jpg" id="img-uploaded" alt="" class="avatar-xl rounded-circle" />
                        <div class="ms-3">
                ...
                <div>
                    ...
                    <form>
                        <div class="row">
                            <div class="mb-3 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    <label class="form-label" for="formFirstName">First Name</label><input
                                        placeholder="First Name" required="" type="text" id="formFirstName"
                                        class="form-control" />
                                </div>
                            </div>
                            <div class="mb-3 col-md-6 col-sm-12">
                            ...
                            <div class="mb-3 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    <label class="form-label" for="formPhone">Phone</label><input placeholder="Phone"
                                        required="" type="text" id="formPhone" class="form-control" />
                                </div>
                            </div>
                            <div class="mb-3 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    <label class="form-label" for="formBirthday">Birthday</label><input
                                        class="form-control flatpickr-input" placeholder="Date of Birth" value=""
                            ...
                            <div class="mb-3 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    <label class="form-label" for="formBirthday">Address Line 1</label><input
                                        placeholder="Address Line 1" required="" type="text" id="formBirthday"
                                        class="form-control" />
                                </div>
                            </div>
                            <div class="mb-3 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    <label class="form-label" for="formBirthday">Address Line 2</label><input
                                        placeholder="Address Line 2" required="" type="text" id="formBirthday"
                                        class="form-control" />
                                </div>
                            </div>
                            <div class="mb-3 col-md-6 col-sm-12">
