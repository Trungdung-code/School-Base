                            ...
                            <form>
                                <div class="mb-5 row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-12">
                                        ...
                                        <small class="text-muted form-text">Add your Twitter username (e.g.
                                            johnsmith).</small>
                                    </div>
                                </div>
                                <div class="mb-5 row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-12">
                                        <input placeholder="Facebook Profile Name" type="text"
                                            class="form-control mb-1 form-control" />
                                        <small class="text-muted form-text">Add your Facebook username (e.g.
                                            johnsmith).</small>
                                    </div>
                                </div>
                                <div class="mb-5 row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-12">
                                        <input placeholder="Instagram Profile Name" type="text"
                                            class="form-control mb-1 form-control" />
                                        <small class="text-muted form-text">Add your Instagram username (e.g.
                                            johnsmith).</small>
                                    </div>
                                </div>
                                <div class="mb-5 row">
