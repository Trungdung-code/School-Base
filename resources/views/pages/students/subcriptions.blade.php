    ...
    <div class="col-lg-9 col-md-8 col-sm-12">
        <div class="border-0 card">
            <div class="d-lg-flex justify-content-between align-items-center card-header">
                ...
                <div>
                    <a class="btn btn-success btn-sm" href="student-subscriptions.html#">Upgrade Now — Go Pro $39.00</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <div class="mb-2 mb-lg-0 col-lg-3 col-md-4 col-sm-5">
                            ...
                            <form>
                                <div class="form-switch">
                                    <input name="radios" type="checkbox" class="form-check-input" checked="" />
                                </div>
                            </form>
                        </div>
                        <div class="d-lg-flex align-items-start justify-content-end col-lg-3 col-md-12 col-sm-12">
                            <a class="btn btn-outline-primary btn-sm" href="student-subscriptions.html#">Change Plan</a>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="pt-5">
                    <div class="mb-4 row">
                        ...
                        <div class="col-auto col">
                            <a class="btn btn-light btn-sm disabled" href="student-subscriptions.html#">Disabled</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-2 mb-lg-0 col-lg-3 col-md-3 col-sm-6">
