        ...
        <div class="row py-5">
                        ...
                        <div class="navbar-collapse collapse" id="navbarNav">
                            <ul class="me-auto flex-column navbar-nav">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" href="privacy-policy.html"><i class="fe fe-lock nav-icon"></i>
                                        Privacy Policy</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="col-lg-9">
                <div class="Edutree-card bg-white shadow-sm overflow-hidden rounded-3">
                    <div class="Edutree-card-header py-3 px-4 text-black fs-5 fw-bold border-bottom text-uppercase">
                        Privacy Policy
                    </div>
                    <div class="Edutree-card-body p-4">
                        <p>
                            At Edutree, accessible from www.Edutree.com, one of our main
                            priorities is the privacy of our visitors. This Privacy Policy
                            document contains types of information that is collected and
                            recorded by Edutree and how we use it.
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            information that they shared and/or collect in Edutree. This
                        ...
                        <h5 class="fw-bold text-black mt-4">
                        ...
                        <p>
                            Edutree follows a standard procedure of using log files. These
                        ...
                        <p>
                            Like any other website, Edutree uses 'cookies'. These cookies
                        ...
                        <p>
                            ...
                            <a href="https://www.generateprivacypolicy.com/#cookies">"Cookies" article from the Privacy
                                Policy Generator</a>.
                        </p>
                        <h5 class="fw-bold text-black mt-4">
                        ...
                        <p>
                            ...
                            the advertising partners of Edutree.
                        </p>
                        <p>
                            Third-party ad servers or ad networks uses technologies like
                            cookies, JavaScript, or Web Beacons that are used in their
                            respective advertisements and links that appear on Edutree,
                        ...
                        <p>
                            Note that Edutree has no access to or control over these cookies
                        ...
                        <p>
                            Edutree's Privacy Policy does not apply to other advertisers or
                        ...
                        <p>
                            Edutree does not knowingly collect any Personal Identifiable
