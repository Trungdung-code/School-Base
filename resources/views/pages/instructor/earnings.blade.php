    ...
    <div class="col-lg-9 col-md-8 col-sm-12">
        <div class="row">
            <div class="mb-4 mb-lg-0 col-lg-4 col-md-12 col-sm-12">
                <div class="h-100 card border-light">
                    <div class="p-0 card-body">
                        <div class="p-4">
                            ...
                            <div class="mb-2 progress" style="height: 2px;">
                                <div role="progressbar" class="progress-bar bg-primary" aria-valuenow="65" aria-valuemin="0"
                ...
                <div class="h-100 card border-light">
                    <div class="p-0 card-body">
                        <div class="p-4">
                            ...
                            <h2 class="h1 fw-bold mb-0 mt-4 lh-1">$3,800</h2>
                            <p>Account Balance</p>
                            <div class="mb-2 progress" style="height: 2px;">
                                <div role="progressbar" class="progress-bar bg-danger" aria-valuenow="65" aria-valuemin="0"
                                    aria-valuemax="100" style="width: 65%;"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="h-100 card border-light">
                    <div class="p-0 card-body">
                        <div class="p-4">
                            ...
                            <h2 class="h1 fw-bold mb-0 mt-4 lh-1">$10,800</h2>
                            <p>Life Time Sales</p>
                            <div class="mb-2 progress" style="height: 2px;">
                                <div role="progressbar" class="progress-bar bg-warning" aria-valuenow="65" aria-valuemin="0"
                                    aria-valuemax="100" style="width: 65%;"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="mb-0 text-nowrap table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle border-top-0">
                                    <div>
                                        <div class="dropdown"><a href="instructor-earnings.html#"><i
                                ...
                                <td class="align-middle border-top-0">
                                    <a href="instructor-earnings.html">
                                        <div class="d-lg-flex align-items-center">
                                            ...
                                            <h5 class="mb-0 ms-lg-3 mt-lg-0 mt-2 text-primary-hover">Guide to
                                                Static Sites with Gatsby</h5>
                                        </div>
                                    </a>
                                </td>
                                ...
                                <td class="align-middle border-top-0">
                                    <a href="instructor-earnings.html">
                                        <div class="d-lg-flex align-items-center">
                                            ...
                                            <h5 class="mb-0 ms-lg-3 mt-lg-0 mt-2 text-primary-hover">The Modern
                                                HTML Courses</h5>
                                        </div>
                                    </a>
                                </td>
